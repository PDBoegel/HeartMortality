...
**Table of Correlations: Using TOTAL POP**
```{r}
...
<<<<<<< HEAD
#cor(heartmort[c(46,48,49,50,51)])
=======
cor(heartmort[c(46,48,49,50,51)])
>>>>>>> 696859a39a5b196a74bd23788e768f6e212d52c5
```
...
```{r}
attach(heartmort)
totlm = lm(LNHDMORTPERPERSON ~ LNTOTLOWEDU + LNTOTMEDEDU + LNTOTHIGHEDU + LNTOTAFRAM + LNTOTASIANAM + LNTOTDIABETES + LNTOTFEMALE + LNTOTMALE + LNTOTNATIVEAM + LNTOTNONELDERLY + LNTOTOBESE + LNTOTUNEMPLOYED + LNTOTWHITE + LNPOPDENSITY + LNHOUSINGUNITSDENSITY + LNAVGINCOMEPERPERSON, data = heartmort)
summary(totlm)
```
