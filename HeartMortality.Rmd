...
which(abs(resid) > 2)
length(which(abs(resid) > 2))
```

```{r, eval = FALSE}
levs <-as.numeric(which(leverage > 3*averagelev))
levs
lev3heartmort = heartmort[-levs,]
lmlev3 = lm(HDMORTPERPERSON ~ LNTOTLOWEDU + LNTOTMEDEDU + LNTOTHIGHEDU + LNTOTAFRAM + LNTOTASIANAM + LNTOTDIABETES + LNTOTFEMALE + LNTOTMALE + LNTOTNATIVEAM + LNTOTNONELDERLY + LNTOTOBESE + LNTOTUNEMPLOYED + LNTOTWHITE + LNPOPSIZE + LNHOUSINGUNITS, data = lev3heartmort)
summary(lmlev3)
```

**TOTLM without high standardized residuals**
```{r}
resid2 = as.numeric(which(abs(resid) > 2))

resid2heartmort = heartmort[-resid2,]
lmresid2 = lm(HDMORTPERPERSON ~ LNTOTLOWEDU + LNTOTMEDEDU + LNTOTHIGHEDU + LNTOTAFRAM + LNTOTASIANAM + LNTOTDIABETES + LNTOTFEMALE + LNTOTMALE + LNTOTNATIVEAM + LNTOTNONELDERLY + LNTOTOBESE + LNTOTUNEMPLOYED + LNTOTWHITE + LNPOPSIZE + LNHOUSINGUNITS, data = resid2heartmort)
summary(lmresid2)
...
```{r}
totalsensheartmort = heartmort[c(-resid2,-levs)]

lmtotalsens = lm(HDMORTPERPERSON ~ LNTOTLOWEDU + LNTOTMEDEDU + LNTOTHIGHEDU + LNTOTAFRAM + LNTOTASIANAM + LNTOTDIABETES + LNTOTFEMALE + LNTOTMALE + LNTOTNATIVEAM + LNTOTNONELDERLY + LNTOTOBESE + LNTOTUNEMPLOYED + LNTOTWHITE + LNPOPSIZE + LNHOUSINGUNITS, data = totalsensheartmort)
summary(lmtotalsens)
